...
2&0xfe0^                                                                0xfc0||(
s=a+2&31                                                                ); }else
{ n,L) for(n=0; n<L 3; n++)     (k,p+        ){ F=k%w* 4|k/w;               float a[6],long=(F-p        /2.) /p;
n,L) for(n=0; n<L 3; n++)     (_,W+){        i=_%I*4|_/I; if(               F<p&i<W){ o=1; L=        i+F*W;if
(l=i&3);        else{ l=F&3; o=W               ; } h=z[L-o*l]; f        =z[L+(4-
l)*o]; t        =F-p/2||i-W/2; r               =h^f; if(!l| !t|(        int)r|(!
(h- 3&3)        &&258063&r>>38))               { float V=(i-W/2.        )/p,U=c,L,i) c*sin(i)+L*cos(i)(
long,1,B),m        =32768,Q=m; a[4]               =c,L,i) c*sin(i)+L*cos(i)(-1,long,B); a[3]=        c,L,i) c*sin(i)+L*cos(i)(U,V,C)
; a[5]=c,L,i) c*sin(i)+L*cos(i)        (-V,U,C); v,L) d=0; y(l,)d+=T(L*l[v],l*20);((a+3               ),s*42); t||(A=d)        ;f=0;n,L) for(n=0; n<L 3; n++)     (n
,){float        N=a[n+3], E=1024               /fabs(N); b= N<0;        float K=
(((q>>20        *n)^~-b)+!b&1023               )/1024.; n,L) for(n=0; n<L 3; n++)     (d,)a[d        ]=a[d+3]
*E; a[n]        =round(a[n]); v,L) d=0; y(l,)d+=T(L*l[v],l*20);(               a,K); i=q+d; v,L) d=0; y(l,)d+=T(L*l[v],l*20);(a,        1); e=E*
K; for(;                e<m; i+=d){ l=q) q>>10&63|q>>24&4032|q>>38&258048       (i); t=r=l^(l^l-(                1<<6*n))
...
int) h|d                <<32|b<<                56; } }}                } q +=A;
XPutImage               (j, u+0,               DefaultGC                (j,J[q) q>>10&63|q>>24&4032|q>>38&258048       (q
)]=0),Y,                0,0,0,0,                W,p); }}                else{ L=
--H/768;                J[H] =rand()%                16*(rand()%4<                abs((H>>
6&63)-32                                                                )+abs((H
>>12&63)                                                                -32)-3); 
i=H &15;                                                                F=H %768
>>4; if(                                                                L<16){if
...
4):rand()%2*5298487:3352537*L*L-14202379*L+19205553; if(L==4)if(F<l+18)a=6990400;else
if(l>F-19)b*=0.7; if(L==3){ if((i-1&15)<14&(F-1&15)<14&!(F&16)){ a=12359778; _=7
-i; k=7-F%16; _^=_>>31; k^=k>>31; b=196-rand()%32+(k>_?k:_)%3*42;} else{ b*=1+rand()%2*(.5
